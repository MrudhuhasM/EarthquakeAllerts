...
public final class QueryUtils {
    ...
    public static void setStartTime(String startTime) {
        QueryUtils.startTime = startTime;
    }
    ...
    public static void setEndTime(String endTime) {
        QueryUtils.endTime = endTime;
    }

    public static String getMinmagnitude() {
        return minmagnitude;
    }

    public static void setMinmagnitude(String minmagnitude) {
        QueryUtils.minmagnitude = minmagnitude;
    }
     ...
     */
    public static List<EarthQuakes> fetchDatafromWeb(String url){
    ...
    private static String makeHttpConnection(URL url1) {
        String jsonresponse = "";
        if (url1 == null)
            return jsonresponse;
    ...
    public static ArrayList<EarthQuakes> extractEarthquakes(String jsonresponse) {
        ...
        ArrayList<EarthQuakes> earthquakeslist = new ArrayList<>();
        ...
        try {
            ...
            for (int i=0;i<earthquakearray.length();i++){
                ...
                String formateDate = formateDate(time);
                String formatTIme = formatTime(time);
                EarthQuakes earthQuakes = new EarthQuakes(location,magnitude,formateDate,formatTIme,url);
    ...
    private static String formatTime(long time) {
        Date timetoFormat = new Date(time);
        SimpleDateFormat timeformat = new SimpleDateFormat("hh:mm a");
        return timeformat.format(timetoFormat);
    }

    private static String formateDate(long time) {
